	...
	<form action="">
		...
		<div class="row mb-3">
			<div class="col">
				...
				<input type="text" class="form-control" id="name_rus" placeholder="Русское название" name="name_rus">
			</div>
			<div class="col">
				<label for="name_origin" class="form-label">Оригинальное название <span class="text-danger">*</span></label>
				<input type="text" class="form-control" id="name_origin" placeholder="Оригинальное название" name="name_origin">
			</div>
		</div>
		<div class="mb-3">
		...
		<div class="row mb-3">
			<div class="col">
				...
				<input type="url" class="form-control" id="wa_url" placeholder="Ссылка на World-Art" name="wa_url">
			</div>
			<div class="col">
				<label for="kp_url" class="form-label">Ссылка на Кинопоиск</label>
				<input type="url" class="form-control" id="kp_url" placeholder="Ссылка на Кинопоиск" name="kp_url">
			</div>
			<div class="col">
				<label for="imdb_url" class="form-label">Ссылка на ImDB</label>
				<input type="url" class="form-control" id="imdb_url" placeholder="Ссылка на ImDB" name="imdb_url">
			</div>
			<div class="col">
				<label for="shikimori_url" class="form-label">Ссылка на Shikimori</label>
				<input type="url" class="form-control" id="shikimori_url" placeholder="Ссылка на Shikimori" name="shikimori_url">
			</div>
		</div>
		<div class="mb-3">
