...
use App\Repository\JobPeopleRepository;
...
class RepositoryServiceProvider extends ServiceProvider
{
	...
	public function register()
	{
		...
		$this->app->bind(JobPeopleRepositoryInterfaces::class, JobPeopleRepository::class);
		...
		$this->app->bind(CharacterRepositoryInterfaces::class, CharacterRepository::class);
	}
